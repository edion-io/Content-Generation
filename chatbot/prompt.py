...
t (exercise type) general type of exercise (Multiple choice, True or False, Short Answer, Arithmetic Exercise, Word Problem, Fill in the Blank, etc) one might encounter in class or a textbook, with each first letter capitalized, like in a title, optional.
